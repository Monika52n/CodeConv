...
dataset = Dataset.from_json("cpp-java.jsonl")  # <-- itt legyen C++ → Java adat
...
# Modell mentése
trainer.save_model("./bloom-cpp2java")
tokenizer.save_pretrained("./bloom-cpp2java")

# 7. Tesztelés új bemenettel
input_text = """
int add(int a, int b) {
    return a + b;
}
